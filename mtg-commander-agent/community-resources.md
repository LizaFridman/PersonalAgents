...
- **Reid Duke's "Level One"** (WOTC free archive — hub article "Level One: The Full Course" on `magic.wizards.com`) — the canonical primer on Magic fundamentals: card advantage and card economy, tempo, threats vs. answers, role assignment ("who's the beatdown"), inevitability, board sweepers, linear vs. interactive strategies, breaking symmetric effects, flexibility, Karsten-style mana-source math, mulligans, sequencing. Written for 1v1 Constructed/Limited — translate to multiplayer Commander: card advantage and board wipes matter *more* (you're outnumbered three-to-one; a wipe answers three boards), tempo and play/draw matter *less*, there's no sideboard, and you hold a table role against each opponent separately. Several of `deckbuilding-framework.md`'s Step 1 / rejection-pattern / strong-inclusion lenses and all of `in-game-play.md` are distilled from it.
